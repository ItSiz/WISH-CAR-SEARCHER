    ...
    return (
        <>
            ...
            <section className='questions-body fuel-body'>
                ...
                <button className='body-questions fuel-questions' onClick={() => setCarFuel("hybrid")}>
                ...
                <button className='body-questions fuel-questions' onClick={() => setCarFuel("electric")}>
                ...
                <button className='body-questions fuel-questions' onClick={() => setCarFuel("alternative")}>
